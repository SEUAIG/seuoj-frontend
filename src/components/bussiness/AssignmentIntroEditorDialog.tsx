...
interface AssignmentIntroEditorDialogProps {
  isOpen: boolean;
  onClose: () => void;
  classId: number;
  assignmentId: number;
  currentIntroduction: string | null;
  currentAttachments: AssignmentIntroAttachment[];
  onSuccess: () => void;
}

export default function AssignmentIntroEditorDialog({
  isOpen,
  onClose,
  classId,
  assignmentId,
  ...
  currentAttachments,
  onSuccess,
}: AssignmentIntroEditorDialogProps) {
  ...
  const handleSubmit = async () => {
    ...
    try {
      ...
      const res = await updateAssignment(classId, assignmentId, {
